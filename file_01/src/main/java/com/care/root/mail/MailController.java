...
public class MailController {
	...
	public void sendSimpleMail(HttpServletRequest request, HttpServletResponse response) 
		...
		ms.sendMail("xorflasla123@hanmail.net","(제목)테스트 메일","(내용)안녕하세요");
	}
	@GetMapping("sendmail2")
	public void sendSimpleMail2(HttpServletRequest request, HttpServletResponse response) 
			throws Exception{
		response.setContentType("text/html; charset=utf-8");
		PrintWriter out = response.getWriter();
		out.print("<h1>메일 전송 되었습니다</h1>");
